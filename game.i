...
void updateEnemy(){
    ...
    for(int i=0;i<20;i++){
...

        {
            ...
            if(dx > -1 * player.width && dx < 5 && dy > -1 * player.height && dy < 5){
                player.status--;
                enemies[i].status = ENEMY_RUINED;
                drawRect(enemies[i].x,enemies[i].y, 5, 5, ((0&31) | (0&31) << 5 | (0&31) << 10));
          drawRect(2 + (5 + 3) * player.status, 2, 5, 5, ((0&31) | (0&31) << 5 | (0&31) << 10));
        ...
        for(int j=0;j<100;j++){
            ...
            if(dx > -1 * 2 && dx < 5 && dy > -1 * 4 && dy < 5){
                bullets[j].status = BULLET_RUINED;
                enemies[i].status = ENEMY_RUINED;

                score += 1;
                drawRect(enemies[i].x,enemies[i].y, 5, 5, ((0&31) | (0&31) << 5 | (0&31) << 10));
                drawRect(bullets[j].x,bullets[j].y, 2, 4, ((0&31) | (0&31) << 5 | (0&31) << 10));
...
void drawPlayer() {
    ...
    if(player.status == 3){
        drawRect(player.x, player.y, player.width, player.height, ((0&31) | (0&31) << 5 | (31&31) << 10));
    }
    if(player.status == 2){
        drawRect(player.x, player.y, player.width, player.height, ((15&31) | (0&31) << 5 | (31&31) << 10));
    }
    if(player.status == 1){
        drawRect(player.x, player.y, player.width, player.height, ((31&31) | (0&31) << 5 | (31&31) << 10));
    }
    drawRect(player.x, player.y, 2, 3, ((0&31) | (0&31) << 5 | (0&31) << 10));
    drawRect(player.width + player.x - 2, player.y, 2, 3, ((0&31) | (0&31) << 5 | (0&31) << 10));


    for(int i=0;i<player.status;i++){
  drawRect(2 + (5 + 3) * i, 2, 5, 5, ((31&31) | (31&31) << 5 | (0&31) << 10));
 }
}
...
void drawBall() {
    for(int i=0;i<20;i++){
        ...
        drawRect(enemies[i].oldx,enemies[i].oldy, 5, 5, ((0&31) | (0&31) << 5 | (0&31) << 10));
        drawRect(enemies[i].x, enemies[i].y, 5, 5, enemies[i].color);
    }
    ...
    for(int i=0;i<100;i++){
        ...
        drawRect(bullets[i].oldx,bullets[i].oldy, 2, 4, ((0&31) | (0&31) << 5 | (0&31) << 10));
        drawRect(bullets[i].x, bullets[i].y, 2, 4, ((0&31) | (31&31) << 5 | (0&31) << 10));
    }

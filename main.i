...
void goToStart() {
    fillScreen(((0&31) | (16&31) << 5 | (16&31) << 10));
    drawString(100, 60, "WELCOME ", ((0&31) | (31&31) << 5 | (0&31) << 10));
    drawString(116, 80, "TO ", ((0&31) | (31&31) << 5 | (0&31) << 10));
    drawString(100, 100, "STARWAR ", ((0&31) | (31&31) << 5 | (0&31) << 10));
    state = START;
    rSeed = 0;
}
...
void game() {
    ...
    waitForVBlank();
    drawGame();
    drawRect(220, 1, 18, 8, ((0&31) | (0&31) << 5 | (0&31) << 10));
    drawString(180, 1, buffer, ((31&31) | (31&31) << 5 | (0&31) << 10));
    if ((!(~(oldButtons) & ((1<<3))) && (~(buttons) & ((1<<3))))) {
        goToPause();
    }
    if (player.status <= 0) {
...
void goToPause() {
    fillScreen(((17&31) | (27&31) << 5 | (31&31) << 10));
    drawString(75, 75, "Game Now Pausing", ((31&31) | (31&31) << 5 | (0&31) << 10));
    waitForVBlank();
    state = PAUSE;
}
...
void goToWin() {
    ...
    drawString(90, 75, "YOU WIN!", ((0&31) | (0&31) << 5 | (0&31) << 10));
    waitForVBlank();
    state = WIN;
}
void win() {
...
void goToLose() {
    fillScreen(((22&31) | (6&31) << 5 | (13&31) << 10));
    drawString(90, 75, "YOU LOSE!", ((31&31) | (31&31) << 5 | (0&31) << 10));
    waitForVBlank();
    state = LOSE;
}
